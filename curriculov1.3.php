<?php
# This part of code need you put the value of variable membro at url like "localhost/curriculov1.3.php?membro=maia"
$membros = ['maia','gus','gabi'];
if (!empty($_GET['membro']) && 
in_array($_GET['membro'], $membros))
{
	require_once $_GET['membro'] .
	'.php';
}
